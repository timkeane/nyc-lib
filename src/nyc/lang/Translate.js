...
Translate.DEFAULT_MESSAGES = {
  ...
  ar: {
    ...
    'msg-yes': 'نعم',
    'msg-no': 'لا',
    'msg-no-dir': 'لم نتمكن من تحديد الإتجاهات من',
  ...
  fr: {
    ...
    'msg-yes': 'Oui',
    'msg-no': 'Non',
    'msg-no-dir': 'Ne peut pas établir l\'itinéraire à partir de',
  ...
  ht: {
    ...
    'msg-yes': 'Wi',
    'msg-no': 'Non',
    'msg-no-dir': 'Nou pa t kapab detèmine chemen pou fè a apatide',
  ...
  po: {
    ...
    'msg-yes': 'Tak',
    'msg-no': 'Nie',
    'msg-no-dir': 'Nie można było ustalić trasy z',
  ...
  ru: {
    ...
    'msg-yes': 'Да',
    'msg-no': 'Нет',
    'msg-no-dir': 'Не смог определить путь от',
  ...
  es: {
    ...
    'msg-yes': 'Sí',
    'msg-no': 'No',
    'msg-no-dir': 'No pudimos establecer la dirección desde',
  ...
  ur: {
    ...
    'msg-yes': 'ہاں',
    'msg-no': 'نہیں',
    'msg-no-dir': 'یہاں سے وہاں تک کی سمت کا تعین نہیں ہو ',
