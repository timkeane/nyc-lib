...
test('constructor checkbox', () => {
  ...
  expect($(choice.find('.chc-chc').get(0)).hasClass(checkChoices[0].name)).toBe(true)
  expect($(choice.find('.chc-chc').get(1)).hasClass(checkChoices[1].name)).toBe(true)
  expect($(choice.find('.chc-chc').get(2)).hasClass(checkChoices[2].name)).toBe(true)
})
...
test('constructor radio', () => {
  ...
  expect($(choice.find('.chc-chc').get(0)).hasClass(`${radioChoices[1].name}-0`)).toBe(true)
  expect($(choice.find('.chc-chc').get(1)).hasClass(`${radioChoices[1].name}-1`)).toBe(true)
  expect($(choice.find('.chc-chc').get(1)).hasClass(`${radioChoices[1].name}-1`)).toBe(true)
})
