...
class Directions extends Contanier {
  ...
  constructor(options) {
    ...
    this.tabs = new Tabs({
      target: '#dir-tabs',
      tabs: [
        {tab: '#map-tab', title: '<span class="msg-dir-map">Route Map</span>'},
        {tab: '#route-tab', title: '<span class="msg-dir">Directions</span>'}
      ]
    })
  ...
  handleResp(response, status) {
    ...
    setTimeout(() => {
      ...
      if (dir.length === 0) {
        dir = '<h2 class="screen-reader-only dir msg-dir">Directions</h2>'
      }
      ...
      <table id="mode">
        <tbody><tr>
          ...
          <td>
            ...
            <button id="mta" class="btn-sq rad-all notranslate" data-msg-key="msg-mta" data-msg-attr="title" title="Get accessible transit directions from the MTA">
