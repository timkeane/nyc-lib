...
QUnit.test('formatNumberHtml (decimal)', function(assert){
	...
	nyc.formatNumberHtml($('.fmt-num'), {style:"decimal", minimumFractionDigits: 3});
...
QUnit.test('formatNumberHtml (currency)', function(assert){
	...
	nyc.formatNumberHtml($('.fmt-num'), {style:"currency", currency: 'USD'});
