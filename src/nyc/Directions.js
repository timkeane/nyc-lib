...
class Directions extends Contanier {
  ...
  handleResp(response, status) {
    ...
    target.children().first().attr('tabindex', 6).focus()
...
Directions.HTML = '<div id="directions">' +
  ...
  '<div id="dir-tabs">' +
    '<div id="route-tab">' +
      ...
      '<div id="fld-from"><input tabindex="0" class="rad-all" placeholder="Enter an address..."></div>' +
      '<div class="fld-lbl">To <span id="fld-facility"></span>:</div>' +
      '<div id="fld-to"></div>' +
      '<table id="mode">' +
        '<tbody><tr>' +
          '<td>' +
            '<button id="transit" tabindex="1" class="btn-sq rad-all active" data-mode="TRANSIT" aria-pressed="true" aria-selected="true" title="Get transit directions">' +
              '<span class="screen-reader-only">get transit directions</span>' +
            '</button>' +
          '</td>' +
          '<td>' +
            '<button id="bike" tabindex="2" class="btn-sq rad-all" data-mode="BICYCLING" aria-pressed="false" aria-selected="false" title="Get bicycling directions">' +
              '<span class="screen-reader-only">get bicycling directions</span>' +
            '</button>' +
          '</td>' +
          '<td>' +
            '<button id="walk" tabindex="3" class="btn-sq rad-all" data-mode="WALKING" aria-pressed="false" aria-selected="false" title="Get walking directions">' +
              '<span class="screen-reader-only">get walking directions</span>' +
            '</button>' +
          '</td>' +
          '<td>' +
            '<button id="car" tabindex="4" class="btn-sq rad-all" data-mode="DRIVING" aria-pressed="false" aria-selected="false" title="Get driving directions">' +
          ...
          '<td>' +
            ...
            '<button id="mta" tabindex="5" class="btn-sq rad-all notranslate">TripPlanner' +
