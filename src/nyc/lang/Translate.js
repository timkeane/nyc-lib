...
Translate.DEFAULT_LANGUAGES = {
  ...
  zh: {code: 'zh-CN', name: 'Chinese (Traditional)', native: '繁體中文', hint: '&#x7FFB;&#x8BD1;'},
...
Translate.DEFAULT_MESSAGES = {
  ...
  bn: {
    ...
    'msg-yes': 'হ্যাঁ',
    'msg-no': 'না',
    'msg-no-dir': 'আপনার অবস্থান থেকে দিকনির্দেশ নির্ধারণ করতে পারেনি',
  ...
  fr: {
    ...
    'msg-yes': 'Oui',
    'msg-no': 'Non',
    'msg-no-dir': 'Impossible de déterminer les directions depuis votre emplacement',
  ...
  ht: {
    ...
    'msg-yes': 'Wi',
    'msg-no': 'Non',
    'msg-no-dir': 'Pa t \'kapab detèmine direksyon ki soti nan kote ou ye',
  ...
  ko: {
    ...
    'msg-yes': '예',
    'msg-no': '아니요',
    'msg-no-dir': '현재 위치에서 길을 찾을 수 없습니다',
  ...
  po: {
    ...
    'msg-yes': 'Tak',
    'msg-no': 'Nie',
    'msg-no-dir': 'Nie można określić wskazówek dotyczących Twojej lokalizacji',
  ...
  ru: {
    ...
    'msg-yes': 'Да',
    'msg-no': 'Нет',
    'msg-no-dir': 'Не удалось определить направление от вашего местоположения',
  ...
  es: {
    ...
    'msg-yes': 'Sí',
    'msg-no': 'No',
    'msg-no-dir': 'No se pudieron determinar las indicaciones desde su ubicación',
  ...
  ur: {
    ...
    'msg-yes': 'ہاں',
    'msg-no': 'نہیں',
    'msg-no-dir': 'آپ کے مقام سے سمت کا تعین نہیں کرسکا',
