...
test('geoclient GEOCLIENT_PLACE_RESPONSE', () => {
  const response = GEOCLIENT_PLACE_RESPONSE
...
test('geoclient GEOCLIENT_NON_ADDRESSABLE_RESPONSE', () => {
  ...
  expect(handler.mock.calls[0][0].input).toBe('Metro North 125 Street, Manhattan')
