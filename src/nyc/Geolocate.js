...
Geolocate.HTML = '<div class="geoloc">' +
  '<button class="btn-geo btn-sq rad-all" data-msg-key="msg-geo" data-msg-attr="title" title="Current location">' +
    '<span class="screen-reader-only msg-geo">Current location</span>' +
