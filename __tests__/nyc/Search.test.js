...
test('constructor target is input', () => {
  ...
  expect(search.getContainer().html()).toBe('<form class="srch input-group" role="search"><input class="rad-all" type="text" placeholder="Search for an address..."><button class="btn btn-srch btn-primary btn-lg">Search</button></form><ul class="rad-all" role="region" label="Possible matches for your search"></ul><ul class="retention"></ul>')
